...
namespace TechnitiumLibrary.Net.Dns.ResourceRecords
{
    public class DnsDIDSUBSIGRecord : DnsResourceRecordData
    {
        ...
        public override void SerializeTo(Utf8JsonWriter jsonWriter)
        {
            ...
            jsonWriter.WriteString("Tag", _didsubsigTag);
            jsonWriter.WriteString("DID", _didsubsigDID);
            jsonWriter.WriteString("SigData", _didsubsigSigData);
        ...
        public override ushort UncompressedLength
        {
            get
            {
                ushort tagLength = Convert.ToUInt16(Convert.ToInt32(Math.Ceiling(_didsubsigTag.Length / 255d)) + _didsubsigTag.Length);
                ushort didLength = Convert.ToUInt16(Convert.ToInt32(Math.Ceiling(_didsubsigDID.Length / 255d)) + _didsubsigDID.Length);
                ushort sigData = Convert.ToUInt16(Convert.ToInt32(Math.Ceiling(_didsubsigSigData.Length / 255d)) + _didsubsigSigData.Length);
                return (ushort)(tagLength + didLength + sigData);
            }
        }
