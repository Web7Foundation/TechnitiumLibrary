...
{
    public class DnsDIDKARecordData : DnsResourceRecordData
    {
        #region variables
        ...
        public DnsDIDKARecordData(VerificationMethodMapDID vmm)
        {
            _vmm = vmm; 
        }

        public DnsDIDKARecordData(Stream s)
            : base(s)
        { }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is DnsDIDKARecordData other)
        ...
        public override void SerializeTo(Utf8JsonWriter jsonWriter)
        {
            ...
            _vmm.SerializeJson(jsonWriter, "keyAgreement");
